...
export class Backend implements backendInterface {
    ...
    async getStartLevel(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getStartLevel();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setStartLevel(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setStartLevel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
